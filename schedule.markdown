...
<div class="kanban">
  ...
  <div class="kb-cell">
    ...
    <div class="kb-card is-blocked">기능 우선순위 기준 수립<em>사용자 확인 대기</em></div>
  </div>
  <div class="kb-cell">
    <div class="kb-card">1~5장 본문 확정 취합</div>
  </div>
  <div class="kb-cell">
...
> 왓슨 · 앨리스 · 토마스 세 레인이 백로그에서 막혀 있습니다. 요구 사항과 기능 우선순위가 확정되지 않아 개발 카드를 배정할 수 없는 상태이며, **10주 일정에서 이 대기가 길어질수록 후반 스프린트가 압축됩니다.** 일정상 가장 먼저 풀어야 할 항목입니다.
...
스프린트 2 이후의 목표는 [2장 개발 요구 사항]({{ '/requirements/' | relative_url }})과 기능 우선순위(필수/선택) 기준이 확정된 뒤 배정합니다. 확정 전에 임의로 채우지 마십시오.
